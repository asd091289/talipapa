import { Box, Card, CardContent, CardHeader, CardMedia, Grid, ImageListItemBar, Stack, styled, Typography } from "@mui/material";
...
const StyledCard = styled(Card)(({ theme }) => ({
  ...
  const Titles = styled(Box)(({ typography }) => ({
    fontWeight: "Bold",
    fontSize: "2rem"
    }));
...
export const Body = (): ReactElement => {
    ...
    <StyledBox>
        ...
        <Stack display="flex" direction="row"  justifyContent="center" gap={5}>
        <Grid><Titles>VEGETABLES</Titles></Grid>
        </Stack>
    ...
    <Stack display="flex" direction="row"  justifyContent="center" gap={5}>
        ...
        <Grid>
         <StyledCard>
            <CardHeader>PECHAY</CardHeader>
                <CardMedia
                 component="img"
                height="140"
                image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRS9Tmf_ZpplisTK-1qv04SxGS7D-FgsUvkSA&usqp=CAU"
                 alt="PECHAY"
                 />
            <CardContent>
            <Typography>Pechay</Typography>
            </CardContent>
         </StyledCard>
        </Grid>
